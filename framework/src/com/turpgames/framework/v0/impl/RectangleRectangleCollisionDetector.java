...
import com.turpgames.framework.v0.IRectangleBound;
...
public class RectangleRectangleCollisionDetector implements ICollisionDetector {
	...
	public boolean detect(IBound bound1, IBound bound2) {
		...
		// return ((l1.x + w1) >= l2.x && l1.x <= l2.x) || (l1.x < l2.x + w2 &&
		// l1.x + w1 > l2.x + w2) &&
		// ((l1.y + h1) >= l2.y && l1.y <= l2.y) || (l1.y < l2.y + h2 && l1.y +
		// h1 > l2.y + h2);
		// TODO: rotation
		return !((l1.y >= l2.y + h2) || (l1.x >= l2.x + w2) || (l1.y + h1 <= l2.y) || (l1.x + w1 <= l2.x));
	}
}