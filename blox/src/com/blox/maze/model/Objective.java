...
public class Objective extends MazeGameObject {
	...
	Objective(float x, float y) {
		this.location.x = x;
		this.location.y = y;
		addAnimation(Animations.Objective, Animations.ObjectiveImagePath, Animations.ObjectiveFrameDuration, 
				Animations.ObjectiveFrameWidth, Animations.ObjectiveFrameHeight);
