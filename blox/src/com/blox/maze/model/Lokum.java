...
public class Lokum extends MazeGameObject {
	...
	public Lokum(Maze maze, float x, float y) {
		...
		addAnimation(Animations.FellOnTrap, Animations.FellOnTrapImagePath, Animations.FellOnTrapFrameDuration, Animations.FellOnTrapFrameWidth, Animations.FellOnTrapFrameHeight);
		addAnimation(Animations.FellOnObjective, Animations.FellOnObjectiveImagePath, Animations.FellOnObjectiveFrameDuration, Animations.FellOnObjectiveFrameWidth,
				Animations.FellOnObjectiveFrameHeight);
		addAnimation(Animations.FellOnPortal, Animations.FellOnPortalImagePath, Animations.FellOnPortalFrameDuration, Animations.FellOnPortalFrameWidth, Animations.FellOnPortalFrameHeight);
