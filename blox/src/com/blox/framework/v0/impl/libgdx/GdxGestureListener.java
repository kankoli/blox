...
class GdxGestureListener implements GestureListener {
	...
	public boolean touchDown(float x, float y, int pointer, int button) {
		return listener.touchDown(x, Game.world.screenHeight - y, pointer, button);
	}

	@Override
	public boolean tap(float x, float y, int count, int button) {
		return listener.tap(x, Game.world.screenHeight - y, count, button);
	}

	@Override
	public boolean longPress(float x, float y) {
		return listener.longPress(x, Game.world.screenHeight - y);
	}
	...
	public boolean pan(float x, float y, float deltaX, float deltaY) {
		return listener.pan(x, Game.world.screenHeight - y, deltaX, deltaY);
	}
	...
	public boolean pinch(Vector2 initialPointer1, Vector2 initialPointer2,
		...
		Vector p2 = new Vector(pointer2.x, Game.world.screenHeight - pointer2.y, 0);
