...
class LearningModeTutorial extends IchiguObject implements IViewFinder {
	...
	LearningModeTutorial(ILearningModeTutorialListener listener) {
		...
		pageInfo.setColor(R.colors.ichiguBlue);
	...
	private void populatePages() {
		...
		page.addInfo("Overview", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
		...
		page.addInfo("Symbols", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
		...
		page.addInfo("Ichigu", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
		...
		info.getColor().set(R.colors.ichiguGreen);
		...
		page.addInfo("Game Modes", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
		...
		page.addInfo("Learning Mode", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
		...
		page.addInfo("Practice Mode", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
		...
		page.addInfo("Relax Mode", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
		...
		page.addInfo("Challenge Mode", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
		...
		page.addInfo("Multiplayer Mode", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
		...
		page.addInfo("Scores", Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguGreen);
