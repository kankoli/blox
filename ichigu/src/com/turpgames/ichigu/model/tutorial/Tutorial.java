...
public class Tutorial extends IchiguObject implements IViewFinder {
	...
	private void populatePages() {
		...
		page.addInfo(Game.getResourceManager().getString(R.strings.tutOverviewTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo(Game.getResourceManager().getString(R.strings.tutOverview), Text.HAlignLeft, 50).setPadX(10);
		pages.add(page);

		page = new TutorialPage("2");
		page.addInfo(Game.getResourceManager().getString(R.strings.tutSymbolsTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo(Game.getResourceManager().getString(R.strings.tutSymbols1), Text.HAlignLeft, 30).setPadX(10);
		pages.add(page);

		page = new TutorialPage("3");
		page.addInfo(Game.getResourceManager().getString(R.strings.tutSymbolsTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		Text info = page.addInfo(Game.getResourceManager().getString(R.strings.tutSymbols2), Text.HAlignCenter, 50);
		float cardSpace = 50;
		...
		page.addInfo(Game.getResourceManager().getString(R.strings.tutIchiguTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo(Game.getResourceManager().getString(R.strings.tutIchigu), Text.HAlignLeft, 50).setPadX(10);
		pages.add(page);

		page = new TutorialPage("5");
		info = page.addInfo(Game.getResourceManager().getString(R.strings.tutSampleIchiguTitle), Text.HAlignCenter, marginTop);
		...
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutDifferentShapes), Text.HAlignLeft, Card.Height + 50 + 30).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutSameColor), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutSamePattern), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutSameCount), Text.HAlignLeft, 20).setPadX(50);
		pages.add(page);
		...
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutSameShape), Text.HAlignLeft, Card.Height + 50 + 30).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutDifferentColors), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutSamePattern), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutSameCount), Text.HAlignLeft, 20).setPadX(50);
		pages.add(page);
		...
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutDifferentColors), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutSamePattern), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutDifferentCounts), Text.HAlignLeft, 20).setPadX(50);
		pages.add(page);
		...
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutDifferentShapes), Text.HAlignLeft, Card.Height + 50 + 30).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutSameColor), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutDifferentPatterns), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutDifferentCounts), Text.HAlignLeft, 20).setPadX(50);
		pages.add(page);
		...
		page.addInfo(Game.getResourceManager().getString(R.strings.tutGameModesTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutSingleIchiguModes), Text.HAlignLeft, 50).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutPracticeModeTitle), Text.HAlignLeft, 30).setPadX(100);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutMiniChallengeModeTitle), Text.HAlignLeft, 30).setPadX(100);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutFullGameModes), Text.HAlignLeft, 50).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutRelaxModeTitle), Text.HAlignLeft, 30).setPadX(100);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutNormalModeTitle), Text.HAlignLeft, 30).setPadX(100);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutFullChallengeModeTitle), Text.HAlignLeft, 30).setPadX(100);
//		page.addInfo("- Multiplayer Mode", Text.HAlignLeft, 30).setPadX(100);
		pages.add(page);

		page = new TutorialPage("11");
		page.addInfo(Game.getResourceManager().getString(R.strings.tutPracticeModeTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo(Game.getResourceManager().getString(R.strings.tutPracticeMode), Text.HAlignLeft, 50).setPadX(10);
		pages.add(page);

		page = new TutorialPage("12");
		page.addInfo(Game.getResourceManager().getString(R.strings.tutMiniChallengeModeTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo(Game.getResourceManager().getString(R.strings.tutMiniChallengeMode), Text.HAlignLeft, 50).setPadX(10);
		pages.add(page);

		page = new TutorialPage("13");
		page.addInfo(Game.getResourceManager().getString(R.strings.tutRelaxModeTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo(Game.getResourceManager().getString(R.strings.tutRelaxMode), Text.HAlignLeft, 50).setPadX(10);
		page.addInfo("", Text.HAlignLeft, 30).setPadX(10);
		page.addInfo("", Text.HAlignLeft, 30).setPadX(10);
		pages.add(page);
		
		page = new TutorialPage("14");
		page.addInfo(Game.getResourceManager().getString(R.strings.tutNormalModeTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo(Game.getResourceManager().getString(R.strings.tutNormalMode), Text.HAlignLeft, 50).setPadX(10);
		pages.add(page);
		
		page = new TutorialPage("15");
		page.addInfo(Game.getResourceManager().getString(R.strings.tutFullChallengeModeTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo(Game.getResourceManager().getString(R.strings.tutFullChallengeMode), Text.HAlignLeft, 50).setPadX(10);
		pages.add(page);
...
//		pages.add(page);
		...
		page.addInfo(Game.getResourceManager().getString(R.strings.tutScoreTitle), Text.HAlignCenter, marginTop).getColor().set(R.colors.ichiguYellow);
		page.addInfo(Game.getResourceManager().getString(R.strings.tutScore), Text.HAlignLeft, 50).setPadX(10);
		pages.add(page);
...
//		pages.add(page);
		...
		info = page.addInfo(Game.getResourceManager().getString(R.strings.tutSampleIchiguScoreTitle), Text.HAlignCenter, marginTop);
		info.getColor().set(R.colors.ichiguYellow);
		...
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutScoreSameShape), Text.HAlignLeft, Card.Height + 30 + 30).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutScoreDifferentColors), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutScoreSamePattern), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutScoreDifferentCounts), Text.HAlignLeft, 20).setPadX(50);
		page.addInfo("- " + Game.getResourceManager().getString(R.strings.tutScoreTotal), Text.HAlignLeft, 20).setPadX(50);
		pages.add(page);
	}
